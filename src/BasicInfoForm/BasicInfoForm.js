...
const BasicInfoForm = ({personName, setPersonName, personAge, setPersonAge, personPhone, setPersonPhone, personPrivacy, setPersonPrivacy}) => {

  return (
    <form className="BasicInfoForm">
      <h1 id="basic-info-header">Basic Information:</h1>
      <div id="fullname-container">
        <label id="fullname-label" htmlFor="fullname"><span className="required-asterisk">*</span>Full Name: </label>
      ...
      <div id="age-container">
        <label id="age-label" htmlFor="age"><span className="required-asterisk">*</span>Age:</label>
      ...
      <div id="privacy-container">
        <label id="privacy-label" htmlFor="privacy">Privacy:</label>
